...
const Contact = () => {
  const details = [
    ...
    },
    {
      ...
      desc: (
        <a
          href="mailto:dev97techsunset@gmail.com"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-800"
        >
          dev97techsunset@gmail.com
        </a>
      ),
    },
    {
      ...
      desc: (
        <a
          href="https://myport-blush.vercel.app"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-800"
        >
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch('https://nodemailer-backend-eight.vercel.app/api/sendEmail', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        Swal.fire({
          icon: 'success',
          title: 'Success!',
          text: 'Your message has been received, I will revert to you sooner!',
          confirmButtonColor: '#fa2d5a',
        });
      } else {
        Swal.fire({
          icon: 'error',
          title: 'Oops...',
          text: 'Failed to send message: ' + result.message,
          confirmButtonColor: '#fa2d5a',
        });
      }
    } catch (error) {
        ...
        <aside className="space-y-6">
          ...
          <div>
            <p className="font-[400] leading-[1.9] font-poppins text-[#666]">
              ...
              <span className="text-[#fa2d5a]">7666895303</span> or <span className="font-[600]">Email:</span>
              <span className="text-[#fa2d5a]"> dev97techsunset@gmail.com</span>
            </p>
          </div>
                ...
                <li key={index}>
                  <div className="font-[400] leading-[12px] text-[#8e8e8e] border-[1px] border-solid border-[#ddd] rounded-[4px] px-[10px] py-[14px] flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-[400] font-poppins text-[14px] text-[#666] mt-4 opacity-[0.8]">
                        {detail.desc}
                      </p>
                    </div>
                  </div>
            ...
            <form className="flex items-center gap-5 flex-col" onSubmit={handleSubmit}>
              <div className="grid md:grid-cols-2 gap-6">
                <input
                  type="text"
                  name="fullname"
                  className="rounded-[4px] font-poppins font-[400] text-[16px] px-4 py-3 outline-none border border-solid border-[#ddd] bg-[#fff] text-[rgb(102,102,102)] placeholder-[#666] transition duration-150 ease-in-out focus:border-[#fa2d5a] focus:shadow-md focus:outline-none"
                ...
                <input
                  type="email"
                  name="email"
                  className="rounded-[4px] font-poppins font-[400] outline-none text-[16px] px-4 py-3 border border-solid border-[#ddd] bg-[#fff] text-[rgb(102,102,102)] placeholder-[#666] transition duration-150 ease-in-out focus:border-[#fa2d5a] focus:shadow-md focus:outline-none"
                ...
                <textarea
                  name="message"
                  className="col-span-2 h-36 rounded-[4px] font-poppins font-[400] outline-none text-[16px] px-4 py-3 border border-solid border-[#ddd] bg-[#fff] text-[rgb(102,102,102)] placeholder-[#666] p-2 transition duration-150 ease-in-out focus:border-[#fa2d5a] focus:shadow-md focus:outline-none"
