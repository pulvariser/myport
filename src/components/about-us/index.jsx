...
const  About  = () => {
  ...
  return (
    <div className='min-h-screen max-w-full space-y-24 mt-20 mb-8 sm:overflow-hidden'>
    <div className='flex items-center justify-center flex-col gap-2 '>
            <p className='text-[14px]  px-[10px]  inline-block  py-[1px] font-poppins bg-[#fa2d5a] rounded-[4px] font-[500] leading-[26px] text-[#fff] shadow'>
             ...
             <p className='text-[16px] leading-[1.8] text-[#6a6a6a] font-[400]  font-poppins md:max-w-[700px] text-center mt-4 '>"I'm a passionate web developer with a knack for creating dynamic, user-friendly websites. I specialize in turning ideas into fully functional digital experiences."</p>
    </div>
     ...
     <div className='md:grid md:grid-cols-3 md:ml-28  my-20 sm:mr-5 md:overflow-hidden sm:overflow-hidden'>
          ...
          <div className='ml-12 flex flex-col gap-6 col-span-2 pr-28 sm:relative sm:left-16' >
             ...
             <div >
                 <ul className='md:grid md:grid-cols-2 md:gap-4 sm:grid sm:gap-4'>
                  {
                     informations.map((information,index)=>{
                       return(
                        <li key={index} className='flex gap-2 '>
                           <span className='capitalize font-[600] font-poppins text-[#666666] text-[15px] opacity-[1]'>{information.info}</span>
                           <span className='font-[400] font-poppins text-[#666666] md:text-[13px] sm:text-[15px] opacity-[0.85]'>{information.value}</span>
                        </li>
                      )})
                  }
                 </ul>
             ...
             <div className='md:flex items-center md:gap-4  mt-3'>
                  ...
                  <button onClick={goToContact} className='text-[15px] sm:ml-1   py-0 px-8 font-poppins bg-[#fa2d5a] rounded-[4px] font-[500] uppercase leading-[46px] text-[#fff] outline-none overflow-hidden  tracking-tighter  hover:bg-[#4671ff] hover:text-[#fff] shadow'>
                     Hire Me
    ...
    <div className='ml-28  min-h-32 flex items-center justify-center'>
       ...
       <ul className='md:grid md:grid-cols-4 md:gap-20 sm:grid sm:grid-cols-2 sm:gap-2 sm:mr-2 md:mr-40 md:ml-20 '>
         {
